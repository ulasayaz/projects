function c = FastA1(x, NameOfDict, par1, par2, par3)
% FastA1 -- the ANALYSIS operator for a dictionary:
%			c = \Phi^T * x
%  Usage:
%	c = FastA1(x, NameOfDict, par1, par2, par3)
%  Inputs:
