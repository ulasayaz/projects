function x = FastS1(c, n, NameOfDict, par1, par2, par3)
% FastS1 -- the SYNTHESIS operator for a dictionary:
%			x = \Phi * c
%  Usage:
%	x = FastS1(c, n, NameOfDict, par1, par2, par3)
%  Inputs:
