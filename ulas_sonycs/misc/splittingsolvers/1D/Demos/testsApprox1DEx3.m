...
%Signal
x = ReadSignal('Greasy'); % Mallat & Zhang (1993).
%x = x(3400:3400+2047); 
...
% ||x||_1 <= R, R is chosen with an oracle (here ~9.3E5, obtained from the BP-DR solution).
tic;xhatlassoprox = real(SolveLassoProx('FastDictOp1D', y, p, 9.3E5, mu, lambdaStop, maxIters, lssolution, 0, 0, 0));timelassoprox=toc
...
saveas(gcf,'1D/Datasets/testsApproxGreasy.fig','fig');
