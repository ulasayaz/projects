...
% ||x||_1 <= R, R is chosen with an oracle (here ~150 for BP-DR solution).
tic;xhatlassoprox = real(SolveLassoProx('FastDictOp1D', y, p, 150, mu, lambdaStop, maxIters, 0, 0, 0, 0));timelassoprox=toc
...
saveas(gcf,'1D/Datasets/testsApproxFMSine.fig','fig');
