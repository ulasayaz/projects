function [xhat, numIters, activeSet] = SolveBPDNDouglasRachford(A, y, p, epsilon, gamma, tightFrame, lambdaStop, maxIters, lssolution, fullPath, verbose, positivity)
...
%
% Usage
%	[xhat, numIters, activeSet] = SolveBPDNDouglasRachford(A, y, p, epsilon, gamma, tightFrame, lambdaStop, maxIters, lssolution, fullPath, verbose, positivity)
% Input
...
while  (iter <= maxIters)
	...
	rproj = max(1 - epsilon/norm(res),0).*res;
        if ~tightFrame
